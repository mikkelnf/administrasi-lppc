...
class CreateDetailEvaluasitugasd3Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detail_evaluasitugasd3', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('detail_evaluasitugasd3');
    }
}

...
class CreateTanggalperiksaRaporPesertaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tanggalperiksa_rapor_peserta', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tanggalperiksa_rapor_peserta');
    }
}
